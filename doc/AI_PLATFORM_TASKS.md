...
| AI-1.2 | Versioned event envelope types + Zod in `app/ai/events/` | NOT_STARTED |
...
| ID | Task | Status |
| --- | --- | --- |
| AI-3.1 | `POST /api/ai/decide` response contract + holdout assignment | NOT_STARTED |
...
| ID | Task | Status |
| --- | --- | --- |
| AI-5.1 | Always-on holdout when decide is enabled (default 10%, configurable) | NOT_STARTED |
