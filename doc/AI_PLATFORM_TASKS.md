...
| AI-5.6 | Bandit **with** holdout retained (do not ship bandit without holdout) | COMPLETE |
...
| AI-6.4 | Autopilot publish = Enterprise only; Standard always review | COMPLETE |
